...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 18 juin 2024 à 16:56
...
CREATE TABLE IF NOT EXISTS `logs` (
  ...
  `log_message` text COLLATE utf8mb4_general_ci NOT NULL
...
(59, 'user', '$2y$10$Qfe/brJqGEnMhnD2C.qCEu0j0lDLq822jQn4UDWGQKM5QcBi1DDnu', 0, 0, 0),
(60, 'super', '$2y$10$tWNOo5/O8W8YyLDxEKtPp.dkd20Pb1ZKgQ5NwvlFUlDH/cA2.TiDK', 2, 0, 0),
(61, 'admin', '$2y$10$9mvR0uNH4TjSsBuKmv/fQulworylGsx0rn3x5Woup/.WTok7zIk.C', 1, 0, 0);
