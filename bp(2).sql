...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 18 juin 2024 à 16:11
...
(41, 'expédition équipement: liste des documents à fournir', 1),
(60, 'Fayza2018!!', 0),
(63, 'khawla', 0);
...
(11, 'admin', '$2y$10$T57sKf0/bJ1TqSWCsZd54eYPGPK4ZmRBC9R3c.lyQkCQTx5DyehWe', 1, 0, 0),
(44, 'faysa', '$2y$10$aoJtrUEZny4ksh4BZqvGZuYSJy94Fr2l.Lk5mwfAOaV2824eT7POm', 0, 2, 0),
(45, 'nasser', '$2y$10$GjiIQvVLLVgCegXrcMV3XOVE7mgUgAvRqKjjej0DmjohR..nk9xKm', 1, 0, 0),
(48, 'cam', '$2y$10$Boe8244S5YkTSiACaOcm2ezI4CR7QSeV9EM8wlBQ5a56P5/9UYVSu', 2, 5, 0),
(49, 'admin', '$2y$10$T57sKf0/bJ1TqSWCsZd54eYPGPK4ZmRBC9R3c.lyQkCQTx5DyehWe', 1, 0, 0),
(51, 'khawla', '$2y$10$.B1d8zB6HToGbXP5UhkqHukQUrDHejhG14y2AHMhvK4qXjKfkZjri', 0, 2, 0);
...
--
-- Index pour la table `bonnespratiques`
--
...
--
-- Index pour la table `passwordrequirements`
--
...
--
-- Index pour la table `pratiquemotscles`
--
...
--
-- Index pour la table `pratiquephases`
--
...
--
-- Index pour la table `pratiqueprog`
--
...
--
-- AUTO_INCREMENT pour la table `bonnespratiques`
--
ALTER TABLE `bonnespratiques`
  MODIFY `IDBonnePratique` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `motscles`
  MODIFY `IDMotsCles` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT pour la table `passwordrequirements`
--
ALTER TABLE `passwordrequirements`
...
--
ALTER TABLE `programmes`
  MODIFY `IDProgramme` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT pour la table `utilisateurs`
--
ALTER TABLE `utilisateurs`
  MODIFY `IDUtilisateur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
